...
export default {
  ...
  mounted: function () {
    ...
    inkStitch.get('stitch_plan').then(response => {
      ...
      Mousetrap.bind("+", this.animationForwardOneStitch) // ForwardOneStitch & BackwardOneStitch bound to multiple keys to make them Shift agnostic
      Mousetrap.bind("=", this.animationForwardOneStitch)
      Mousetrap.bind("-", this.animationBackwardOneStitch) 
      Mousetrap.bind("_", this.animationBackwardOneStitch)
